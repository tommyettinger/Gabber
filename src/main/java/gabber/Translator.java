...
//z
    ...
    private String addPart(String original, int syllables)
    {
        ...
        switch (cacheLevel) {
            case 2: reverseDictionary.put(done, original);
            case 1: dictionary.put(original, done);
        }
        return done;
    }
    /**
    ...
    public String lookup(String source)
    {
        ...
        if(dictionary.containsKey(s2))
            ...
            */
            ...
            switch (cacheLevel) {
                case 2: reverseDictionary.put(ciphered, s2);
                case 1: dictionary.put(s2, ciphered);
            }
        }
     ...
     * translates each word to the fake language, using existing translations if previous calls to translate() or lookup()
